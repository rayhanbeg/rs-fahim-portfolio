      ...
      <div className="container mx-auto px-8 md:px-16 lg:px-24">
        ...
        <div className="flex flex-col md:flex-row items-center md:space-x-12">
          ...
          <div className="flex-1">
            ...
            Hello! My name is Rs Fahim, and I am currently a student at Alhaz Mockbul Hossain College. I belong to the session of 2023-2024. This portfolio is a small representation of my academic journey and achievements so far.
